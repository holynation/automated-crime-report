                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <div class="card-title-group align-start mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Total Users Wallet</h6>
                                        </div>
                                        <div class="card-tools">
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <div class="card-title-group align-start mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Total Superagents Wallet</h6>
                                        </div>
                                        <div class="card-tools">
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <div class="card-title-group align-start mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Total Agents Wallet</h6>
                                        </div>
                                        <div class="card-tools">
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    ...
                                    <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                        <div class="nk-sale-data">
                                            <span class="amount"><?php echo number_format($countData['cashback']); ?></span>
                                        </div>
                                    </div>
                                    <div class="info">
                                        <span class="text-success"><a href="<?= base_url("vc/create/cashback"); ?>" class="text-success">Total Sales Amount</a>
                                            <em class="icon ni ni-arrow-long-up text-success"></em>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    ...
                                    <div class="info">
                                        <span class="text-success"><a href="<?= base_url("vc/create/cashback"); ?>" class="text-success">Today's Total Sales</a>
                                            <em class="icon ni ni-arrow-long-up text-success"></em>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    ...
                                    <div class="info">
                                        <span class="text-success"><a href="<?= base_url("vc/create/cashback"); ?>" class="text-success">Today's Sales Sum Total</a>
                                            <em class="icon ni ni-arrow-long-up text-success"></em>
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <div class="card-title-group align-start mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Daily Check-in</h6>
                                        </div>
                                        <div class="card-tools">
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    <div class="card-title-group align-start mb-2">
                                        <div class="card-title">
                                            <h6 class="title">Check-in Amount</h6>
                                        </div>
                                        <div class="card-tools">
